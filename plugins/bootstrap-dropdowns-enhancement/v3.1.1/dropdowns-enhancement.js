/**
 * Created by kevin on 2016/07/06.
 */
/* ========================================================================
...
(function($) {
    ...
    var toggle   = '[data-toggle="dropdown"]',
        ...
        openClass = 'open',
        activeClass = '[data-toggle="dropdown"].active-toggle',
    ...
    proto.toggle = function(event) {
        ...
        // if category active, close/open functionality for 'initial' 

        if($(activeClass).length > 0) {
            if($element.hasClass(activeToggle)) {
                $parent.removeClass(openClass);
                $element.removeClass(activeToggle);
            } else {
                $(activeClass).parent().removeClass(openClass);
