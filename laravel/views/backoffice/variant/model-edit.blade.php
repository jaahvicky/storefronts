<div class="modal-dialog">
	<div class="modal-content">
		{!! Form::open(['route' => 'admin.variant.add', 'id'=>'variant-post']) !!}
		...
		<div class="modal-body">
			...
			<div class="form-group ">
				<label for="variant_name">Attribute name</label>
				 <input type="text" name="variant_name" id="variant_name" class="form-control" value="{{ $variant->name}}" />
			</div>
		</div>
		<div class="modal-footer">
			<button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cancel</button>
                        <a id="submit-status" class="btn btn-sm btn-primary pull-right"> Save </a>
		</div>
		{!! Form::close() !!}
	</div>
</div>
