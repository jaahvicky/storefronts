        ...
        <div class="col-xs-7 clearfix">
            ...
            <div class="dropdown sort-results pull-right">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                    <li><a href="{{URL::route('store-category', ['slug'=>$store->slug, 'categorySlug' => $category->slug, 'sortby'=>'newest'])}}"  data-url="{{URL::route('store', ['slug'=>$store->slug, 'sortby'=>'newest'])}}" >Newest</a></li>
                    <li><a href="{{URL::route('store-category', ['slug'=>$store->slug, 'categorySlug' => $category->slug, 'sortby'=>'highest'])}}" >Highest to lowest price</a></li>
                    <li><a href="{{URL::route('store-category', ['slug'=>$store->slug, 'categorySlug' => $category->slug, 'sortby'=>'lowest'])}}" >Lowest to highest price</a></li>
                </ul>
            </div>
        </div>
    </div>    
